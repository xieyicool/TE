...
<div class="bd">
	...
	<div class="weui_cells weui_cells_form" style="margin-top: 0em;">
		<div class="weui_cell" style="padding-top: 5px; padding-bottom: 5px;">
			...
			<div class="weui_cell_bd weui_cell_primary" align="right">
				<img class="weui_media_appmsg_thumb"
					src="../image/weui/eg_planets.jpg" width="60" height="60">
			</div>
		</div>
		<div class="weui_cell" style="padding-top: 5px; padding-bottom: 5px;">
			<div class="weui_cell_hd">
				<label class="weui_label">工号</label>
			</div>
			<div class="weui_cell_bd weui_cell_primary" align="right">
		...
		<div class="weui_cell" style="padding-top: 5px; padding-bottom: 5px">
			<div class="weui_cell_hd">
				<label class="weui_label">汇报上级</label>
			</div>
			<div class="weui_cell_bd weui_cell_primary" align="right">
		...
		<div class="weui_cell" style="padding-top: 5px; padding-bottom: 5px">
			<div class="weui_cell_hd">
				<label class="weui_label">入职日期</label>
			</div>
			<div class="weui_cell_bd weui_cell_primary" align="right">
		...
		<div class="weui_cell" style="padding-top: 5px; padding-bottom: 5px">
			<div class="weui_cell_hd">
				<label class="weui_label">在职状态</label>
			</div>
			<div class="weui_cell_bd weui_cell_primary" align="right">
